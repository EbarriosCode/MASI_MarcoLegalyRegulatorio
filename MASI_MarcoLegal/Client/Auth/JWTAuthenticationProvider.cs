using MASI_MarcoLegal.Client.Helpers;
        ...
        private IEnumerable<Claim> ParseClaimsFromJwt(string jwt)
        {
            ...
            if (roles != null)
            {
                if (roles.ToString().Trim().StartsWith("["))
                {
                    ...
                    {
                        claims.Add(new Claim(ClaimTypes.Role, parsedRole.ToString().Trim()));
                    }
                }
                else
                {
                    claims.Add(new Claim(ClaimTypes.Role, roles.ToString().Trim()));
                }
